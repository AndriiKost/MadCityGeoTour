...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_services_geoObject_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/services/geoObject.service */ "./src/app/services/geoObject.service.ts");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/fesm5/ngx-spinner.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ModalWindowComponent = /** @class */ (function () {
    function ModalWindowComponent(geoObjectService, spinner) {
        this.geoObjectService = geoObjectService;
        this.spinner = spinner;
    ...
    ModalWindowComponent.prototype.getObjectDescription = function () {
        var _this = this;
        this.spinner.show();
        var id = this.geoObject._id;
        this.geoObjectService.getObjectsDetails(id).subscribe(function (objectDetails) {
            _this.objectDescription = objectDetails.description;
            _this.spinner.hide();
        });
    };
    ...
    ModalWindowComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_geoObject_service__WEBPACK_IMPORTED_MODULE_1__["GeoObjectService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"]])
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validateService, flashMessage, authService, router, geoObjectService, spinner) {
...
var GeoObjectService = /** @class */ (function () {
    function GeoObjectService(http) {
        ...
        this.url = 'https://madcitygeotour.herokuapp.com';
    }
    ...
    GeoObjectService.prototype.getObjectsDetails = function (id) {
        // const url = `http://localhost:8000/geo-objects/${id}`;
        // const url = 'https://madcitygeotour.herokuapp.com/profile';
        return this.http.get(this.url + "/geo-objects/" + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getObjectsDetails', [])));
    };
    GeoObjectService.prototype.getAllObjects = function () {
        ...
        return this.http.get(this.url + "/geo-objects/")
